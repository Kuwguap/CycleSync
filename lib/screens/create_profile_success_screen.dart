...
class CreateProfileSuccessScreen extends StatefulWidget {
  const CreateProfileSuccessScreen({super.key});

  @override
  State<CreateProfileSuccessScreen> createState() => _CreateProfileSuccessScreenState();
}
